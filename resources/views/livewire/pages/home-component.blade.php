<div>
        ...
        <div class="st-hero st-style1">
          <div class="container">
            <div class="st-hero-text">
              ...
              <div class="st-hero-subtitle">{!! $slider->subtitle !!}</div>
          ...
          <div class="st-hero-social-group">
            <div class="container">
              <ul class="st-social-btn st-style1 st-mp0">
                <li><a href="{{ $slider->facebook }}"><i class="fab fa-facebook-square"></i></a></li>
                <li><a href="{{ $slider->linkedin }}"><i class="fab fa-linkedin"></i></a></li>
                <li><a href="{{ $slider->twitter }}"><i class="fab fa-pinterest-square"></i></a></li>
                <li><a href="{{ $slider->youtube }}"><i class="fab fa-twitter-square"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          @forelse ($aboutus as $about )
           @if ($about->title)
              <h2 class="st-section-heading-title">{{ $about->title }}</h2>
              @endif
              ...
              @if ($about->subtitle)
              <div class="st-section-heading-subtitle">{!! $about->subtitle !!}</div>
              @endif
          @empty
            ...
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in">
                <div class="st-text-block st-style1">
                   @if ($about->name)
                  <h2 class="st-text-block-title">{!! $about->name !!}</h2>
                  @endif
                  ...
                  <div class="st-text-block-avatar">
                    ...
                    <div class="st-avatar-info">
                       @if ($about->aname)
                      <h4 class="st-avatar-name">{{ $about->aname }}</h4>
                      @endif
                       @if ($about->designation)
                      <div class="st-avatar-designation">{!! $about->designation !!}</div>
                      @endif
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    ...
                    <input type="text" id="uname" name="uname" placeholder="Jhon Doe"  wire:model="uname"  wire:keyup="generateSlug" required/>
                ...
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    ...
                    <input type="text" id="uemail" name="uemail" placeholder="example@gmail.com"  wire:model="uemail" required/>
                     @error('uemail')<p class="text-danger">{{ $message }}</p>@enderror
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    <label>Phone Number</label>
                    <input type="text" id="unumber" name="unumber" placeholder="+00 141 23 234"  wire:model="unumber" required/>
                     @error('unumber')<p class="text-danger">{{ $message }}</p>@enderror
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    <label>Booking Date</label>
                    <input name="udate" type="text" id="udate" placeholder="dd/mm/yy"  wire:model="udate" onchange="this.dispatchEvent(new InputEvent('input'))"/>
                    <div class="form-field-icon"><i class="fa fa-calendar"></i></div>
                     @error('udate')<p class="text-danger">{{ $message }}</p>@enderror
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    ...
                    <select name="udepartment" id="udepartment" class="st_select1" data-placeholder="Select department"  wire:model="udepartment">
                      <option></option>
                      @foreach ($departmentslists as $dlist )
                      <option value="{{ $dlist->name }}">{{ $dlist->name }}</option>
                      @endforeach
                    </select>
                     @error('udepartment')<p class="text-danger">{{ $message }}</p>@enderror
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    <label>Doctor</label>
                    <div class="st-custom-select-wrap">
                      <select name="udoctor" class="st_select1" id="udoctor" data-placeholder="Select doctor"  wire:model="udoctor">
                        <option></option>
                         @foreach ($udoctors as $doctor )
                        <option value="{{ $doctor->name }}">{{ $doctor->name }}</option>
                         @endforeach
                      </select>
                       @error('udoctor')<p class="text-danger">{{ $message }}</p>@enderror
                    </div>
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="st-form-field st-style1">
                    <label>Message</label>
                    <textarea cols="30" rows="10" id="umsg" name="umsg" placeholder="Write something here..."  wire:model="umsg"></textarea>
                     @error('umsg')<p class="text-danger">{{ $message }}</p>@enderror
                  </div>
                </div>
                <div class="col-lg-12">
                  <button class="st-btn st-style1 st-color1 st-size-medium" type="submit" wire:click.prevent="addAppointment()">Appointment</button>
                </div>
              </div>
            </form>  
          </div>
                  ...
                  <div class="st-member-img">
                    ...
                    <div class="st-member-social-wrap">
                      ...
                      <ul class="st-member-social st-mp0">
                        ...
                        <li><a href="{{ $doctors->twitter }}"><i class="fab fa-twitter-square"></i></a></li>
                      </ul>
                    </div>
                  </div>
                  <div class="st-member-meta">
                    <div class="st-member-meta-in">
                      <h3 class="st-member-name"><a href="doctor-profile.html">{{ $doctors->name }}</a></h3>
                      <div class="st-member-designation">{{ $doctors->designation }}</div>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section class="st-faq-wrap st-shape-wrap">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <h2 class="st-accordian-heading">{{ $faq->heading }}</h2>
             @endif
              @empty
            ...
            <div class="st-accordian-wrap">
              @forelse ($faqs as $faq )
              <div class="st-accordian{{ $loop->first ? ' active' : '' }}">
                <div class="st-accordian-title">
                  {{ $faq->title }}
                  <span class="st-accordian-toggle fa fa-angle-down"></span>
                </div>
                <div class="st-accordian-body">{!! $faq->body!!}</div>
              </div><!-- .st-accordian -->
              @empty
    ...
    <section class="st-news-letter-section st-dynamic-bg st-bg" data-src="{{ asset('assets/img/news-letter-bg.png')}}">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
           @livewire('pages.news-letter-components')
          </div>
        </div>
      </div>
      <div class="st-height-b120 st-height-lg-b80"></div>
            ...
            <div class="st-post st-style3">
              ...
              <div class="st-post-info">
                ...
                <div class="st-post-meta">
                  <span class="st-post-date">{{ $blog->created_at }}</span>
                  <span>
                    Posted by:<a href="#" class="st-post-avatar">
                      <span class="st-post-avatar-text"> {{ $blog->postedby }}</span>
                    </a>
                  </span>
                </div>
                <div class="st-post-text">{{ $blog->desc }}</div>
              </div>
    ...
    @livewire('pages.contact-form-components')
    <!-- End Contact Section -->
