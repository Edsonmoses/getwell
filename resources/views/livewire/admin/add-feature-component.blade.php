                  ...
                  <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type="submit" id="SubmitBtn" value="Save Feature" name="submit" wire:click.prevent="addFeatures()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
