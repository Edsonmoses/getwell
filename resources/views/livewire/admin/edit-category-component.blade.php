                ...
                @endif
                  <div class="row">
                        <div class="button-list mb-1" style="text-align: right;">
                            <a href="{{ route('admin.category') }}" type="button" class="btn btn-primary waves-effect waves-light">All Categories</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="submit" id="SubmitBtn" value="Update Category" name="submit" wire:click.prevent="addCategory()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
