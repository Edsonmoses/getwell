                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="avatar"/>
                                    @if ($avatar)
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type="submit" id="SubmitBtn" value="Save About us" name="submit" wire:click.prevent="addAbout()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
