                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="form-horizontal" files="true" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="faqbg"/>
                                    @if ($faqbg)
                                    <img src="{{ $faqbg->temporaryUrl() }}" width="120"/>
                                    @endif
                                    @error('faqbg')<p class="text-danger">{{ $message }}</p>@enderror
                                </div>
                                @endif
                        </div> <!-- end col -->
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="faqimg"/>
                                    @if ($faqimg)
                                    <img src="{{ $faqimg->temporaryUrl() }}" width="120"/>
                                    @endif
                                    @error('faqimg')<p class="text-danger">{{ $message }}</p>@enderror
                                </div>
                                @endif
                        </div> <!-- end col -->
                        <div class="col-lg-12">
                            ...
                            <input type="submit" id="SubmitBtn" value="Save Faq" name="submit" wire:click.prevent="addFaqs()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
