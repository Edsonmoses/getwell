                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="form-horizontal" files="true" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="newicon"/>
                                    @if($newicon)
                                            <img src="{{ $newicon->temporaryUrl() }}" width="120"/>
                                        @else
                                            <img src="{{ asset('assets/img/funfacts')}}/{{ $icon }}" width="120"/>
                                        @endif
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="newvideoimg"/>
                                    @if($newvideoimg)
                                            <img src="{{ $newvideoimg->temporaryUrl() }}" width="120"/>
                                        @else
                                            <img src="{{ asset('assets/img/funfacts')}}/{{ $videoimg }}" width="120"/>
                                        @endif
                                    @error('newvideoimg')<p class="text-danger">{{ $message }}</p>@enderror
                                </div>
                        </div> <!-- end col -->
                            <input type="submit" id="SubmitBtn" value="Update Funfact" name="submit" wire:click.prevent="updateFunfacts()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
