                  ...
                  <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="submit" id="SubmitBtn" value="Save Category" name="submit" wire:click.prevent="addCategory()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
