                  ...
                  <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="submit" id="SubmitBtn" value="Save Logo" name="submit" wire:click.prevent="addLogos()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
