                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="form-horizontal" files="true" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="image" multiple/>
                                      @if($image)
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="imageBg"/>
                                    @if ($imageBg)
                                    <img src="{{ $imageBg->temporaryUrl() }}" width="120"/>
                                    @endif
                                    @error('imageBg')<p class="text-danger">{{ $message }}</p>@enderror
                                </div>
                        </div> <!-- end col -->
                            <input type="submit" id="SubmitBtn" value="Save Gallery" name="submit" wire:click.prevent="addGallery()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
