                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control"  wire:model="newhero"/>
                                        @if($newhero)
                                            <img src="{{ $newhero->temporaryUrl() }}" width="120"/>
                                        @else
                                            <img src="{{ asset('assets/img/hero')}}/{{ $hero }}" width="120"/>
                                        @endif
                                    @error('hero')<p class="text-danger">{{ $message }}</p>@enderror
                                </div>
                        </div> <!-- end col -->
                            <input type="submit" id="SubmitBtn" value="Update Hero" name="submit" wire:click.prevent="updateSlider()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
