                  ...
                  <div class="row">
                    ...
                    <div class="row">
                            ...
                            <form class="form-horizontal" files="true" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($newimage)
                                        ...
                                        @else
                                            <img src="{{ asset('assets/img/teams')}}/{{ $image }}" width="120"/>
                                        @endif
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="submit" id="SubmitBtn" value="Update Teams" name="submit" wire:click.prevent="updateTeams()" class="btn btn-info rounded-pill waves-effect waves-light col-md-2">
                    </form>
                    </div>
                    <!-- end row-->
