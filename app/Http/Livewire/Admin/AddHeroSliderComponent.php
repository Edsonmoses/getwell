...
class AddHeroSliderComponent extends Component
{
    use WithFileUploads;
    public $title;
    public $slug;
    ...
    public function updated($fields)
    {
        ...
        if ($this->hero) {
            $this->validateOnly($fields, [
                'hero' => 'required|mimes:png,jpg,jpeg,webp',
            ]);
        }
    }
    ...
    public function addSlider()
    {
        ...
        $imageName = Carbon::now()->timestamp . '.' . $this->hero->extension();
        $this->hero->storeAs('hero', $imageName);
        $hero->hero = $imageName;
        $hero->save();
        session()->flash('message', 'Hero slider has been created successfully!');
    }
    public function render()
    {
        return view('livewire.admin.add-hero-slider-component')->layout('layouts.base');
    }
}
