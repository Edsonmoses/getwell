...
class AppointmentComponent extends Component
{
    ...
    {
        $appointments = Appointments::where('status', 'open')->orderBy('created_at', 'desc')->get();
        return view('livewire.admin.appointment-component', ['appointments' => $appointments])->layout('layouts.base');
    }
