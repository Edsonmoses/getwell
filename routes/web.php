...
Route::middleware(['auth', 'authadmin'])->group(function () {
    ...
    //Appointment
    Route::get('/admin/appointment', AppointmentComponent::class)->name('admin.appointment');
    Route::get('/admin/closed', ClosedAppointmentComponent::class)->name('admin.closed');
    //Team
    ...
    Route::get('/admin/contact-form/{slug}', ContactFormComponent::class)->name('admin.contactform');
});
